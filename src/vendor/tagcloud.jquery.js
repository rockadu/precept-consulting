 ...
 *
 * Vendored from https://github.com/dynamicguy/tagcloud
 * Mouse coordinates use getBoundingClientRect so the sphere tracks
 * correctly inside a nested layout.
 */
(function ($) {
  var tags;
  var mathAssets = {
  ...
  function initContainer(tagContainer) {
    ...
    tagContainer.mousemove(function (e) {
      ...
      curState.mouseX = e.pageX - (rect.left + window.scrollX);
      curState.mouseY = e.pageY - (rect.top + window.scrollY);
    });
    tagContainer.hover(
      function () {
